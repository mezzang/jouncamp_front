...
const DataDetail = () => {
  ...
  useEffect(() => {
    ...
    const fetchDataDetail = async () => {
      try {
        ...
        console.error("자료 상세 가져오기 오류:", error);
        setLoading(false);
      }
    };
  ...
  const handleBackToList = () => {
    navigate(
      `/Data/Index?Page=${page}&SearchField=${searchField}&SearchQuery=${searchQuery}`
    );
  };
              ...
              <Card>
                ...
                <CardBody>
                  ...
                  <PostMeta>
                    ...
                    <span>
                      조회수: {Number(data.read_cnt).toLocaleString()}
                    </span>
                    <span>
                      등록일:{" "}
                ...
                {(data.filename1 || data.filename2 || data.filename3) && (
                  <CardFooter>
                    <FileList>
                      {data.filename1 && (
                        <FileItem>
